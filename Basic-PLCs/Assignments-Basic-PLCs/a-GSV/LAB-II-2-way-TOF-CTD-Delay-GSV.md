# 2-way TOF + CTD + TOF delay + GSV capture

Create a LAB routine for North-South traffic lights using these instructions.

## NORTH-SOUTH TRAFFIC

- (3) TOF timers for N-S traffic lights
- (1) CTD counter to track the number of loops
