...
- Properly wire (2) circuits in PARALLEL from the TRANSFORMER secondary (X1-X2): 
...
![Pushbutton](Assignment-Motors-Basic-Images/NO-NC-Pushbutton.png)

## SIMPLE LADDER DIAGRAM

```text
F1            N.O.               GREEN LIGHT            X2
|------------[   ]------------------( G )-----------------|
|                                                         |
|             N.C.                RED LIGHT               |
|------------[ / ]------------------( R )-----------------|
